...
return [
    ...
    'account' => [
        ...
        'form' => [
            ...
            'default_avatar' => 'Default company logo',
            'default_avatar_helper' => 'Default company logo when no logo is uploaded. If you do not select any image, it will be generated using your logo or the first character of company name.',
        ],
    ],
    'invoice' => [
        'name' => 'Invoice',
